...
-- Listage des données de la table testdb.employes : ~4 rows (environ)
/*!40000 ALTER TABLE `employes` DISABLE KEYS */;
INSERT INTO `employes` (`id`, `user_id`, `nom`, `sexe`, `DateNais`, `formations`, `competences`, `villeResidence`, `cv`, `created_at`, `updated_at`) VALUES
	(1, 2, 'macbook', 'M', '2000-01-01 00:00:00', 'probatoire;bepc;bacc;licence;master', 'angular;ionic;laravel;sql;react;vuejs;scss', 'yaounde', 'C:\\Users\\SCOFIELD\\Downloads\\CV wilfried-old.pdf', '2022-03-31 11:03:57', '2022-03-31 11:03:57'),
	(2, 11, 'client1', 'M', '2000-01-01 00:00:00', 'probatoire;bepc;bacc;licence', 'angular;sql;laravel', 'yaounde', 'C:\\Users\\SCOFIELD\\Downloads\\CV wilfried-old.pdf', '2022-03-31 11:03:57', '2022-03-31 11:03:57'),
	(3, 13, 'client3', 'F', '2000-01-01 00:00:00', 'probatoire;bepc', 'react;sql;laravel', 'yaounde', 'C:\\Users\\SCOFIELD\\Downloads\\CV wilfried-old.pdf', '2022-03-31 11:03:57', '2022-03-31 11:03:57'),
	(4, 12, 'client2', 'F', '2000-01-01 00:00:00', 'bepc', 'react', 'yaounde', 'C:\\Users\\SCOFIELD\\Downloads\\CV wilfried-old.pdf', '2022-03-31 11:03:57', '2022-03-31 11:03:57');
/*!40000 ALTER TABLE `employes` ENABLE KEYS */;

-- Listage des données de la table testdb.employeurs : ~9 rows (environ)
/*!40000 ALTER TABLE `employeurs` DISABLE KEYS */;
INSERT INTO `employeurs` (`id`, `user_id`, `nom`, `description`, `Secteur_activité`, `ville`, `created_at`, `updated_at`) VALUES
	(1, 1, 'goStartup', 'Entreprise spécialisé dans le developpement d\'application de web,mobile et desktop', 'Informatique', 'Yaounde', '2022-03-31 11:02:46', '2022-03-31 11:02:46'),
	(2, 3, 'SAFIVS SA', 'Société Africaine de Fabrication', 'Agroalimentaire', 'Yaounde', '2022-03-31 15:23:24', '2022-03-31 15:23:33'),
	(3, 10, 'KRMA', 'KRMA est une jeune entreprise de gestion des risques spécialisée dans les risques agricoles et financiers. Basée au quartier Bastos de Yaoundé, l’entreprise accompagne ses clients dans la prévention, le suivi et le pilotage des risques liés à leurs activités agricoles et/ou financières.', 'Agriculture', 'Yaounde', '2022-03-31 16:00:22', '2022-03-31 16:00:23'),
	(4, 9, 'IKWEN', 'ikwen is an internet company located in Yaoundé. We are providing B2B Cloud solutions and also B2C products.', 'Informatique, SSII, Internet', 'Yaounde', '2022-03-31 16:02:11', '2022-03-31 16:02:12'),
	(5, 7, 'DORCAS TECHNOLOGIES', 'Entreprise spécialisé dans le debogage des applications mobile et desktop', 'Informatique', 'Douala', '2022-03-31 11:02:46', '2022-03-31 11:02:46'),
	(6, 5, 'BUSINESSONE SARL', 'Societe Camerounaise de trading', 'CryptoMonnaie', 'Douala', '2022-03-31 15:23:24', '2022-03-31 15:23:33'),
	(7, 6, 'ALPHOSA', 'Centre de formation en conduite automobile categorie A(moto) et B(voiture 4 roues) ', 'Formation automobile', 'Buea', '2022-03-31 15:23:24', '2022-03-31 15:23:33'),
	(8, 4, 'AFRICASHORE', 'Maison de publication et edition de livre(roman,etc...)', 'Edition', 'Dschang', '2022-03-31 15:23:24', '2022-03-31 15:23:33'),
	(9, 8, 'KOUHSI', 'Societe à Responsabilités Limités ayant pour principal fonction les impressions de toutes natures et infographie et serigraphie generale', 'Infographie,Serigraphie', 'Dschang', '2022-03-31 15:23:24', '2022-03-31 15:23:33');
/*!40000 ALTER TABLE `employeurs` ENABLE KEYS */;

-- Listage des données de la table testdb.offres : ~5 rows (environ)
...
INSERT INTO `offres` (`id`, `employeur_id`, `libelle`, `description`, `dateExpiration`, `posteVise`, `competencesRequises`, `typeOffre`, `created_at`, `updated_at`) VALUES
	...
	(2, 1, 'Recherche d\'un web designer', 'web designer temps plein', '2022-04-19 14:42:04', 'web designer', 'css3;bootstrap;sass;scss', 'temps plein', '2022-03-31 14:42:46', '2022-03-31 14:43:08'),
	...
	(4, 3, 'Expert des Risques Agricoles', 'Le candidat sera rattaché à la Division des Risques Agricoles et aura pour principales missions :', '2022-02-21 16:03:13', 'Expert des Risques Agricoles', 'Bac+3', 'temps plein', '2022-03-31 16:03:50', '2022-03-31 16:03:56'),
...
-- Listage des données de la table testdb.personal_access_tokens : ~64 rows (environ)
...
-- Listage des données de la table testdb.users : ~18 rows (environ)
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `type`) VALUES
	...
	(11, 'client1', 'client@gmail.cm', NULL, '$2y$10$pCGLvhtHedSVnu.1Ev6NWeg2E7590UhazCQsU17LiylRUaxAWCgIu', NULL, '2022-03-31 14:58:26', '2022-03-31 14:58:26', 'employe'),
